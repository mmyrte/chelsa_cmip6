...
class clim_class:
    ...
    def bio8(self):
        ...
        res_arr = quarter_class(self.pr, self.tas, "sum", "mean", "max", "max").comp_quarters_array()
        return res_arr

    def bio9(self):
        """Mean Temperature of the driest Quarter"""
        res_arr = quarter_class(self.pr, self.tas, "sum", "mean", "min", "max").comp_quarters_array()
        return res_arr

    def bio10(self):
        """Mean Temperature of the warmest Quarter"""
        res_arr = quarter_class(self.tas, self.tasmax, "mean", "mean", "max", "max").comp_quarters_array()
        return res_arr

    def bio11(self):
        """Mean Temperature of Wettest Quarter"""
        res_arr = quarter_class(self.tas, self.tasmin, "mean", "mean", "max", "max").comp_quarters_array()
        return res_arr
    ...
    def bio16(self):
        ...
        res_arr = quarter_class(self.pr, self.pr, "sum", "sum", "max", "max").comp_quarters_array()
        return res_arr

    def bio17(self):
        """Precipitation of Driest Quarter"""
        res_arr = quarter_class(self.pr, self.pr, "sum", "sum", "min", "max").comp_quarters_array()
        return res_arr

    def bio18(self):
        """Precipitation of Warmest Quarter"""
        res_arr = quarter_class(self.pr, self.tasmax, "sum", "mean", "max", "max").comp_quarters_array()
        return res_arr
